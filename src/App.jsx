...
export default function App() {
  ...
  const canBuy = (currentSquare !== null && myMoney >= reqMoney && myTrust >= reqTrust);
  ...
  const isTradeActive = (gameData.pendingTrade !== null && (isOfflineMode || pendingBuyerId === activePlayerIndex));
